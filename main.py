...
#se filtrados, a lista mostrar_produtos recebe o retorno da função filtro, que pedirá como será o filtro
#e retornará uma lista com os produtos que fazer parte desse
...
#se está, entra no looping que diminui o custo do limite_credito, aumenta o total_de_gastos e usa
...
#3- Pagamento: recebe o pagamento, que aumenta o limite_credito, limpa a lista de compras e diminiu o total_de_gastos
